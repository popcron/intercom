...
public class Updater : Editor
{
    ...
    private const string PackageName = "com.popcron.intercom";
    private const string PackageURL = "https://raw.githubusercontent.com/popcron/intercom/master/package.json";
    private const string CanUpdateKey = "Popcron.Intercom.CanUpdate";
    private const string CheckForUpdateText = "Popcron/Intercom/Check for updates";
    private const string UpdateText = "Popcron/Intercom/Update";
